# PY_IP_WA_PROJECT
CONTAINS FINAL VERSION OF THE PROJECT WEATHER APPLICATION FOR ROBOT DREAMS PYTHON COURSE
...
Upresnenie: Údaje, ktoré budú preberané z portálu a následne spracúvané a zobrazované sú:
...
Apikácia WEATHER ANALYTICS 2024 vypočíta z vyššie uvedených prevzatých údajov parametre počasia v období 02.03.2024 - 15.03.2024
uvedené nižšie pre mestá BRATISLAVA (SK) a VICTORIA (CA).
Vypočítané hodnoty parametrov zobrazí samostatne do tabuľky pre mesto BRATISLAVA (SK) a VICTORIA (CA).
